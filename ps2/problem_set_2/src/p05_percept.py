...
def update_state(state, kernel, learning_rate, x_i, y_i):
    ...
    """
    # *** START CODE HERE ***
    beta_i = learning_rate * (
        y_i - sign(sum(beta * kernel(x, x_i) for beta, x in state))
    )
...
def train_perceptron(kernel_name, kernel, learning_rate):
    ...
    """
    train_x, train_y = util.load_csv(r"D:\AI\ml\ps2\data\ds5_train .csv")
    ...
    test_x, test_y = util.load_csv(r"D:\AI\ml\ps2\data\ds5_test.csv")
